...
@WebServlet("/doctor/delete-account")
public class DoctorDeleteAccountServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<title>MediCare+ &#8212; Delete Doctor Account</title>");
        ...
        NavHelper.writeDoctorSidebar(out, doctorName, "delete");
        ...
        out.println("      <ul>");
        out.println("        <li>All your personal and professional data will be deleted</li>");
        out.println("        <li>Your appointment history will be removed</li>");
        out.println("        <li>All patient records linked to you will be permanently erased</li>");
        out.println("      </ul>");
        out.println("    </div>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Step 1: Delete appointments for this doctor
            String deleteAppts = "DELETE FROM appointments WHERE doctor_id = ?";
            pstmt = conn.prepareStatement(deleteAppts);
            pstmt.setInt(1, doctorId);
            pstmt.executeUpdate();
            pstmt.close();

            // Step 2: Delete doctor_profiles record
            String deleteInfo = "DELETE FROM doctor_profiles WHERE doctor_id = ?";
            pstmt = conn.prepareStatement(deleteInfo);
            pstmt.setInt(1, doctorId);
            pstmt.executeUpdate();
            pstmt.close();

            // Step 3: Delete from doctor_accounts table
            String deleteSql = "DELETE FROM doctor_accounts WHERE username = ?";
            ...
            if (rowsDeleted > 0) {
                // Account deleted - invalidate session
